...
print("🔍 Testing Fixed AzureOpenAI Client")
print("=" * 50)
...
try:
    ...
    if foundry_key and foundry_endpoint:
        print("\n🧪 Testing corrected initialization...")
        
        try:
            # Corrected initialization with required api_version
            client = AzureOpenAI(
                api_key=foundry_key,
            ...
            response = client.chat.completions.create(
                ...
                messages=[{"role": "user", "content": "Hello! This is a test from the EHR system."}],
                max_tokens=50,
                temperature=0.7
            )
